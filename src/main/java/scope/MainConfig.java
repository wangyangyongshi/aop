...
import impo.Color;
import impo.MyImportBeanDefinitionRegistrar;
import impo.MyImportSelector;
import impo.MybeanPostProcessor;
 ...
 */
@Configuration
@Import({Color.class, MyImportSelector.class, MyImportBeanDefinitionRegistrar.class, MybeanPostProcessor.class})
